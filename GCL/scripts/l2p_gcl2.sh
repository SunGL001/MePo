...
META_PATH="/data/sunguanglong/meta_vit2/R100_noW_sup_sample_200_lr_0.1_numtask_50_steps_1/meta_epoch_5.pth"
...
# META_PATH="/data/sunguanglong/meta_vit2/R100_noW_ibot_sample_200_lr_0.1_numtask_50_steps_1/meta_epoch_30.pth"
...
NOTE=${METHOD}_coef_${COR_COEF}_${DATASET}_${CHECKPOINT}
N_TASKS=5
N=50
M=10
...
do
    ...
    --meta_path $META_PATH > /home/sunguanglong/DGIL/MISA/results/output/vit_nips/$NOTE.txt 2>&1
done
