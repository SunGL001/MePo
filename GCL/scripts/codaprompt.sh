...
# CIL CONFIG
# NOTE="NP-SALM-N101M0_T1_prompt_IMGNT500_samcl_add_random_allprompt_proj_moreaug_epoch5_rho.1_sample1800000" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
# NOTE="NP-SALM-N101M0_T1_prompt_CUB200_samcl_add_random_allprompt_proj_moreaug_epoch5_rho.1_lr1e-5"
# NOTE="CodaPrompt-load"
...
if [ "$DATASET" == "cifar100" ]; then
    ...
    MODEL_NAME="CodaPrompt" EVAL_PERIOD=1000
    ...
    MEM_SIZE=0 ONLINE_ITER=3
    MODEL_NAME="CodaPrompt" EVAL_PERIOD=15000
    BATCHSIZE=64; LR=5e-3 OPT_NAME="adam" SCHED_NAME="default" MEMORY_EPOCH=100
