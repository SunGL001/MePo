...
# META_PATH="/data/sunguanglong/meta_vit2/R100_noW_sup1k_sample_200_lr_0.1_numtask_50_steps_1/meta_epoch_0.pth"
...
do
    ...
    --meta_path $META_PATH > /home/sunguanglong/DGIL/MISA/results/output/vit_gcl/$NOTE.txt 2>&1
done
